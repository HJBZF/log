  ...
  <ul class="headTopUl clearfix">
    <li class="headTopUser">
      <ul class="headTopList clearfix">
        <li class="headRelat listmore"> <em class="moreico">woico</em> <a class="Gray7" href="#">更多</a> <b class="triangleT">triangle</b>
        ...
        <li class="headRelat list"> <em class="woico">woico</em> <a class="Gray7" rel="nofollow" href="#">我的窝窝</a> <b class="triangleT">triangle</b>
    ...
    <li class="headTopLogin"> <span class="Gray7" id="toplogin"> 您好！请 [<a class="yellowd1" rel="nofollow" href="wwtproduct.action?op=toShowLogin">登录</a>] <b class="borderdc">|</b> [<a class="yellowd1" rel="nofollow" href="wwtproduct.action?op=toShowReg">注册</a>] <b class="borderdc p_0_10">|</b> </span> <span id="topusername" class="yellowd1"> 您好，<a class="yellowd1" href="" id="uname"></a> &nbsp; <a class="Gray7" href="javascript:void"  id="loginout">退出</a> <b class="borderdc p_0_10">|</b> </span>
      <ul class="clearfix">
...
<div id="headMin">
  <ul class="headConul clearfix">
    ...
    <li class="cityBox">
      ...
      <span class="cityLink"> 【<a class="Gray5a" href="#" gae="city_list">切换城市</a>】 </span> <span id="show_city" class="cityTs"> <b class="triangbor">三角</b> <a id="ipClose" class="closeTs" href="#">关闭</a> 您是不是在 <em id="ipcityname" class="bluec4">衡阳</em> ？点击可选择其他城市 </span> </li>
    <li class="searchLi ">
...
<div id="payprocess">
    ...
    <table width="918" cellspacing="0" cellpadding="0" border="0">
      <thead>
        <tr>
          ...
          <th class="last" width="138" valign="middle"> <span>总价</span> </th>
        </tr>
      </thead>
      <tbody>
        <tr>
          <td valign="middle" height="60"><a href="#"> <span class="title">98元虾巢香辣虾双人套餐</span> </a></td>
          <td valign="middle" height="60" align="center"><span class="price">¥144.00</span></td>
          <td valign="middle" height="60" align="center"><span class="price">¥98.00</span></td>
          <td valign="middle" height="60"><div class="numbox">
          ...
          <td class="last" valign="middle" height="60" align="center"><span id="yprice" class="price">¥98.00</span></td>
        </tr>
      </tbody>
      <tfoot>
        <tr>
          <td valign="middle" height="60" colspan="4"><span class="title redb">应付总额</span></td>
          <td class="last" valign="middle" align="center"><strong class="price" style="float:right">¥98.00</strong> <b style="display:block;float:right;margin-right:20px;font-size:14px;line-height:33px;color:red"></b></td>
        </tr>
        <tr>
          <td colspan="5"></td>
        </tr>
  ...
  <div class="subbox"> <a id="nextbtn" class="next" type="next" href="javascript:;">确认购买</a> <a id="nextbtn" class="next" type="next" href="javascript:;">清空订单</a> <a id="nextbtn" class="next" type="next" href="javascript:;">继续购物</a> </div>
