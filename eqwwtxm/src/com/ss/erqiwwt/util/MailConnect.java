...
public class MailConnect{
	 ...
	 * @return
	 */
	public static boolean sendQQmail(String from_email,String pwd,String str,String code,String name,String usid){
		...
		try {
			...
			String content="<span style=\"font-size:16px;font-weight:blod;font-family:'微软雅黑'\">尊敬的 "+name+" ，您好：</span><br /><br />" +
					"<div style='width:1000px'>&nbsp;&nbsp;&nbsp;&nbsp;<span style=\"font-size:14px;font-family:'微软雅黑'\">" +
					"欢迎注册窝窝团，请点击一下链接激活账号！<br/>"
					+ "http://192.168.73.1:8080/eqwwtxm/userInfoServlet?op=jihuo&code="+code+"&usid="+usid
					+ "<br/>20分钟内有效，请尽快完成注册。期待您的加入！</span><br/><br /><span style=\"font-size:14px;font-family:'微软雅黑';float:right;\">"
